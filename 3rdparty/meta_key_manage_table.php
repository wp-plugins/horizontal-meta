...
class meta_key_manage_table extends WP_List_Table {
	...
	function check_permissions() {
		if ( !current_user_can('manage_options') )
			wp_die(__('You do not have permission to view this resource.'));
	}
	...
	function single_row( $item ) {
		...
		?>
		<tr data-meta-type="<?php print $item["type"]; ?>" data-meta-key="<?php print $item["meta_key"]; ?>" class="hm-pointer hm-row-data hm-hover-state">
